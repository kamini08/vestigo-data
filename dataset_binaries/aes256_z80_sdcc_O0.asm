...
;/work/source_code/aes256.c:103: if (i % 8 == 0) {
	...
	ld	h, -1 (ix)
	push	hl
	C$aes256.c$106$2_0$51	= .
	.globl	C$aes256.c$106$2_0$51
;/work/source_code/aes256.c:106: temp[0] = temp[1];
	...
	ld	d, -8 (ix)
	inc	de
	C$aes256.c$107$2_0$51	= .
	.globl	C$aes256.c$107$2_0$51
;/work/source_code/aes256.c:107: temp[1] = temp[2];
	...
	adc	a, #0x00
	ld	-6 (ix), a
	C$aes256.c$108$2_0$51	= .
	.globl	C$aes256.c$108$2_0$51
;/work/source_code/aes256.c:108: temp[2] = temp[3];
	...
	adc	a, #0x00
	ld	-4 (ix), a
	C$aes256.c$103$3_0$53	= .
	.globl	C$aes256.c$103$3_0$53
;/work/source_code/aes256.c:103: if (i % 8 == 0) {
	ld	a, b
	or	a, c
	jp	NZ, 00104$
...
;/work/source_code/aes256.c:171: aes256_encrypt(plaintext, ciphertext, key);
	...
	ld	sp, hl
	pop	bc
	C$aes256.c$173$1_0$61	= .
	.globl	C$aes256.c$173$1_0$61
;/work/source_code/aes256.c:173: printf("AES-256 Encryption\n");
	push	bc
	ld	hl, #___str_1
	push	hl
	call	_puts
	pop	af
	pop	bc
	C$aes256.c$174$1_0$61	= .
	.globl	C$aes256.c$174$1_0$61
;/work/source_code/aes256.c:174: printf("Plaintext:  ");
	push	bc
	ld	hl, #___str_2
	push	hl
	call	_printf
