...
;/work/source_code/testingfiles/xor.c:148: xor_decrypt_block(ct,dt,&ctx);
	...
	pop	de
	C$xor.c$150$1_2$112	= .
	.globl	C$xor.c$150$1_2$112
;/work/source_code/testingfiles/xor.c:150: printf("Block:\n");
	push	de
	ld	hl, #___str_5
	push	hl
	call	_puts
	...
	pop	de
	C$xor.c$151$1_2$112	= .
	.globl	C$xor.c$151$1_2$112
;/work/source_code/testingfiles/xor.c:151: printf("Plain : ");
	push	de
	ld	hl, #___str_6
	push	hl
	call	_printf
