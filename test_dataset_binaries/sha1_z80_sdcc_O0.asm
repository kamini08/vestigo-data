...
;/work/source_code/testingfiles/sha1.c:154: sha1_final_alt(&ctx, digest);
	...
	pop	bc
	C$sha1.c$156$1_0$59	= .
	.globl	C$sha1.c$156$1_0$59
;/work/source_code/testingfiles/sha1.c:156: printf("Alternate SHA-1 Implementation\n");
	push	bc
	ld	hl, #___str_2
	push	hl
	call	_puts
	...
	pop	bc
	C$sha1.c$157$1_0$59	= .
	.globl	C$sha1.c$157$1_0$59
;/work/source_code/testingfiles/sha1.c:157: printf("Message: %s\nSHA-1: ", msg);
	push	bc
	ld	hl, #___str_0
	push	hl
	ld	hl, #___str_3
